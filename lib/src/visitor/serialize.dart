  ...
  void visitColor(SassColor value) {
    switch (value.space) {
      ...
      case ColorSpace.oklab:
        ...
        _writeNumber(value.channel0);
        if (!_isCompressed && value.space == ColorSpace.lab) {
          _buffer.writeCharCode($percent);
        }
        _buffer.writeCharCode($space);
        _writeNumber(value.channel1);
        _buffer.writeCharCode($space);
        _writeNumber(value.channel2);
      ...
      case ColorSpace.oklch:
        ...
        _buffer.writeCharCode($space);
        _writeNumber(value.channel2);
        if (!_isCompressed) _buffer.write('deg');
        _maybeWriteSlashAlpha(value.alpha);
        _buffer.writeCharCode($rparen);
        break;
      ...
      default:
        _buffer
          ...
          ..write(value.space)
          ..writeCharCode($space);
        _writeBetween(value.channels, ' ', _writeNumber);
        _maybeWriteSlashAlpha(value.alpha);
        _buffer.writeCharCode($rparen);
        break;
    }
